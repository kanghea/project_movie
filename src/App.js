  ...
  return <div>
    {
      ...
      <div className="w-full bg-orange-400 h-16">
        <div className="flex columns-5 items-center h-full">
          ...
          <a href="/read1" className="w-auto h-full pl-10">
            <img src="img/lol.png" className="w-auto h-full pl-10"></img>
          </a>
          <div className="flex-none grow col-span-1"></div>
...
function HeaderB() {
  ...
  return <>
    {
      event &&
      <div className="w-full h-24 opacity-90 fixed blur-sm">
        <div className="flex flex-row grow-0 pl-52 pr-52 pt- bg-black align-middle">
...
function Header() {
  return <>
    <div className="w-full h-28">
      <div className="h-full flex grow-0 bg-white justify-between pl-52 pr-52">
        <div className="flex-none basis-48 w-40">
          <a href="/">
            <img alt="logo" src="img/logo.png" />
          </a>
